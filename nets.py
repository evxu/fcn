...
def  resnet_v1_101 (X, num_classes=2):
    with tf.name_scope('resnet_v1_101'):
        net, _ = resnet_v1.resnet_v1_101(X,
                                num_classes=num_classes,
                                global_pool = False,
                                output_stride = 16)
        net = slim.conv2d_transpose(net, num_classes, 31, 16, scope='upscale')
...
def  resnet_v1_152 (X, num_classes=2):
    with tf.name_scope('resnet_v1_152'):
...
def  resnet_v1_200 (X, num_classes=2):
    with tf.name_scope('resnet_v1_200'):
        net, _ = resnet_v1.resnet_v1_200(X,
                                num_classes=num_classes,
                                global_pool = False,
                                output_stride = 16)
        net = slim.conv2d_transpose(net, num_classes, 31, 16, scope='upscale')
